...
use MillCloud\Backtrace\Arguments\ArgumentReducers;
use MillCloud\Backtrace\Arguments\Reducers\ArgumentReducer;
use MillCloud\FlareClient\Concerns\HasContext;
use MillCloud\FlareClient\Context\BaseContextProviderDetector;
use MillCloud\FlareClient\Context\ContextProviderDetector;
use MillCloud\FlareClient\Enums\MessageLevels;
use MillCloud\FlareClient\FlareMiddleware\AddEnvironmentInformation;
use MillCloud\FlareClient\FlareMiddleware\AddGlows;
...
use MillCloud\FlareClient\Glows\Glow;
use MillCloud\FlareClient\Glows\GlowRecorder;
use MillCloud\FlareClient\Http\Client;
use Throwable;
...
class Flare
{
    ...
    /**
     * @param \MillCloud\FlareClient\Http\Client $client
     * @param \MillCloud\FlareClient\Context\ContextProviderDetector|null $contextDetector
